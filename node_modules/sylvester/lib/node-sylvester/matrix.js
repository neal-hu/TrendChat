...
Matrix.prototype = {
    ...
    //Set the value in matrix by index
    set: function(i,j,value){
 	if (i < 1 || i > this.elements.length || j < 1 || j > this.elements[0].length) { return null; }
	return this.elements[i - 1][j - 1]=value;   	
    },
    ...
    // Return the result of dot multiply
    dotMultiply: function(matrix){
    	return this.map(function(k, i, j){
    		return matrix.e(i,j) * k;
    	});
    },
    // Return the result of dot divid
    dotDiv: function(matrix){
    	return this.map(function(k, i, j){
    		return k / matrix.e(i,j);
    	});
    },
